package by.bsuir.lab3.domain.record.impl;
...
public class SerializableStudentRecordImpl implements StudentRecord, Serializable {
    private int group;
    private String name;
    ...
    public SerializableStudentRecordImpl(int group, String name, String surname, String address, Date dateOfBirth) {
    ...
    public SerializableStudentRecordImpl(StudentRecord record) {
        this(record.getGroup(), record.getName(), record.getSurname(), record.getAddress(), record.getDateOfBirth());
    }

    public SerializableStudentRecordImpl() {
    }
    ...
    public boolean equals(Object o) {
        SerializableStudentRecordImpl toCompare = (SerializableStudentRecordImpl) o;
